...
type PatientPreorder struct {
	...
	PaymentType *AllOfPatientPreorderPaymentType `json:"payment_type,omitempty"`
	...
	Status *AllOfPatientPreorderStatus `json:"status,omitempty"`
