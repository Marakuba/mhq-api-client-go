 ...
 * @param optional nil or *DocsApiDocsApiV2SchemaRetrieveOpts - Optional Parameters:
     * @param "Format" (optional.String) - 
     * @param "Lang" (optional.String) - 
@return map[string]Object
*/

type DocsApiDocsApiV2SchemaRetrieveOpts struct {
    Format optional.String
    Lang optional.String
}

func (a *DocsApiService) DocsApiV2SchemaRetrieve(ctx context.Context, localVarOptionals *DocsApiDocsApiV2SchemaRetrieveOpts) (map[string]Object, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/docs/api/v2/schema"
